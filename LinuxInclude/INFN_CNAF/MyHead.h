...
const static std::string evDistr_final_plot = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/Stuff/DAMPE-GAcceptance/results/1527159147_acceptance_result.root";

//////////////////////////// Outh paths for logs and ROOT files:

const static std::string output_log = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/Salomon/logs/";
const static std::string output_root = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/Salomon/results/";
