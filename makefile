...
#program name
S_DIR  = $(TOP)/SalomonXProject/SalomonXProject/source/

CNAF_PATH = /storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/Salomon
HOME_SERVER_PATH = /home/enrico/Documents/DAMPE/MyRepos/Salomon

ifeq ($(shell uname -s),Linux) # LINUX
    ifneq ("$(wildcard $(CNAF_PATH))","")
        S_INC = $(TOP)/LinuxInclude/INFN_CNAF
        DEBUG_DIR    = Debug/linux/INFN_CNAF/obj
        RELEASE_DIR  = Release/linux/INFN_CNAF/obj
        DEBUG_PROG   = Debug/linux/INFN_CNAF/Salomon
        RELEASE_PROG = Release/linux/INFN_CNAF/Salomon
    else
        S_INC = $(TOP)/LinuxInclude/HomeServer
        DEBUG_DIR    = Debug/linux/HomeServer/obj
        RELEASE_DIR  = Release/linux/HomeServer/obj
        DEBUG_PROG   = Debug/linux/HomeServer/Salomon
        RELEASE_PROG = Release/linux/HomeServer/Salomon
    endif
endif

ifeq ($(shell uname -s),Darwin) # macOS
	S_INC  = $(TOP)/SalomonXProject/SalomonXProject/include/
	DEBUG_DIR    = Debug/macOS/obj
        RELEASE_DIR  = Release/macOS/obj
        DEBUG_PROG   = Debug/macOS/Salomon
        RELEASE_PROG = Release/macOS/Salomon
endif
