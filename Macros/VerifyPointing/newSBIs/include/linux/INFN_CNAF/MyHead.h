...
const std::string evDistr_final_plot = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/Stuff/DAMPE-GAcceptance/results/GAcceptanceFinalPlot.root";
const static std::string output_root = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/Salomon/Macros/VerifyPointing/newSBIs/results/";
...
extern void from_local_to_galactic(Double_t costheta,Double_t phi,Double_t &l,Double_t &b,Double_t sat_ra[],Double_t sat_dec[]);
