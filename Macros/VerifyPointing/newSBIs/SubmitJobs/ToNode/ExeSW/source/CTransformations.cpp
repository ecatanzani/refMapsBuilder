...
void from_local_to_galactic(Double_t costheta,Double_t phi,Double_t &l,Double_t &b,Double_t sat_ra[],Double_t sat_dec[]) {
...
void from_satellite_to_celestial(Double_t ra[],Double_t dec[],double vectorin[],AtPolarVect &vector_out) {
    Float_t ux1[3];
    Float_t uy1[3];
    Float_t uz1[3];
    Float_t rax = ra[0];
