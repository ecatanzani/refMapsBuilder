...
export WORKDIR="/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/Salomon/Macros/VerifyPointing/newSBIs/SubmitJobs/Local"
if [[ ! -d $WORKDIR ]]; then echo "$WORKDIR does not exist" >&2; exit 1; fi

export EXEC="${WORKDIR}/ExeSW/Release/JPVerify"
