...
const static std::string output_root = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/Salomon/Macros/VerifyPointing/oldSBIs/results/";
...
extern void Iris(Int_t s_events,TH2D &IRISmap,TH2D &evDist,Float_t sat_ra[],Float_t sat_dec[]);
